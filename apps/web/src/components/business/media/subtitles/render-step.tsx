...
} from '~/lib/features/subtitle/config/presets'
import type {
	HintTextConfig,
	SubtitleRenderConfig,
	SubtitleRenderPreset,
	TimeSegmentEffect,
} from '~/lib/features/subtitle/types'
import { areConfigsEqual } from '~/lib/features/subtitle/utils/config'
import { HintTextConfigControls } from './hint-text-config-controls'
import { SubtitleConfigControls } from './subtitle-config-controls'
import { TimeSegmentEffectsManager } from './time-segment-effects-manager'
