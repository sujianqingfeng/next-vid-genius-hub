...
import type { HintTextConfig } from '~/lib/features/subtitle/types'
 ...
 * 提示文本覆盖层组件
 */
export function HintTextOverlay({
	config,
	containerHeight,
}: HintTextOverlayProps) {
	...
	const textShadowBlur = Math.max(
		fontSize * UI_CONSTANTS.TEXT_SHADOW_BLUR_RATIO,
