				...
				{items.length === 0 ? (
					...
					<div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
						{items.map((thread) => (
							<Card
								key={thread.id}
								className="rounded-none group flex flex-col transition-all hover:shadow-md border-border/60 hover:border-border p-0 gap-0"
							>
								...
								<CardFooter className="p-4 pt-0 text-[10px] text-muted-foreground font-mono uppercase tracking-widest border-t border-border/40 mt-auto bg-muted/10">
