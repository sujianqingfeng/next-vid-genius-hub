...
function AdminAiProvidersPage() {
	...
	const testProvider = useEnhancedMutation(queryOrpcNext.admin.testAiProvider.mutationOptions(), {
												...
												<div className="flex items-center gap-2">
													...
													{p.kind === 'llm' ? (
														<Button
															...
															onClick={() => testProvider.mutate({ providerId: p.id })}
														>
															{t('actions.test')}
														</Button>
													) : null}
					...
					{editing ? (
						<div className="space-y-4">
							...
							<div className="space-y-2">
								...
								<Select
									value={editing.type}
									onValueChange={(v) => setEditing({ ...editing, type: v as ProviderType })}
								>
									<SelectTrigger>
										<SelectValue />
									</SelectTrigger>
					...
					<DialogFooter>
						...
						<Button
							...
							onClick={() => {
								...
								const maxUploadBytes = maxUploadBytesRaw ? Number(maxUploadBytesRaw) : undefined
								const asrMetadata =
									editing.kind === 'asr'
										? {
