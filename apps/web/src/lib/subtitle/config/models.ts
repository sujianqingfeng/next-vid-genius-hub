...
export const CLOUDFLARE_INPUT_FORMAT_VALUES = [
	'binary',
	'array',
	'base64',
] as const
export const cloudflareInputFormatSchema = z.enum(
	CLOUDFLARE_INPUT_FORMAT_VALUES,
)
...
export function getDefaultModel(provider: TranscriptionProvider): WhisperModel {
	...
	const defaultModel = availableModels.find(
		(modelId) => WHISPER_MODELS[modelId].isDefault,
	)
